...
the cited pages' bounding boxes highlighted on the original PDF page. The
boxes come in the orchestrator's `evidence_boxes` field beside the answer, so
the answer's citations keep the strict schema.
